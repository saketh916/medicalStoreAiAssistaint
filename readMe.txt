...
## Overview
**Medical Store AI Assistant** is an AI-driven web application designed to help users search for medicines and explore their safe, reliable alternatives. The app integrates the **GEMINI API** to fetch real-time data about medicines and provides a seamless, user-friendly experience.  

🌐 **Live Demo**: https://medical-store-assistaint.vercel.app/

---

## Features 🚀
- 🔍 **Medicine Search**: Enter a generic medicine name to get top alternatives.
- 💡 **Real-Time Data**: Integrated with **GEMINI API** to provide up-to-date results.
...
- Cloud Deployment: AWS CloudFront, vercel
